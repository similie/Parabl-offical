! function() {
    ...
    function i(t) {
        ...
        i = "function" == typeof t ? t : t ? function() {
            ...
            var o;
            t = n(" "), i = n(" "), e = n(" ");
            for (var r = 0; r < arguments.length; r++)(t -= n(arguments[r])) < 0 && (t += 1), (i -= n(arguments[r])) < 0 && (i += 1), (e -= n(arguments[r])) < 0 && (e += 1);
            return n = null,
                function() {
                    var n = 2091639 * t + 2.3283064365386963e-10 * s;
                    return t = i, i = e, e = n - (s = 0 | n)
                }
        }(t) : Math.random, this.p = e(i), this.perm = new Uint8Array(512), this.permMod12 = new Uint8Array(512);
        for (var s = 0; s < 512; s++) this.perm[s] = this.p[255 & s], this.permMod12[s] = this.perm[s] % 12
    }
    ...
    i.prototype = {
        ...
        noise3D: function(i, e, s) {
            var n, o, r, a, h, c, d, l, u, f, g = this.permMod12,
                v = this.perm,
                p = this.grad3,
                m = (i + e + s) * (1 / 3),
                w = Math.floor(i + m),
                ...
                _ = e - (b - y),
                A = s - (x - y);
            M >= _ ? _ >= A ? (h = 1, c = 0, d = 0, l = 1, u = 1, f = 0) : M >= A ? (h = 1, c = 0, d = 0, l = 1, u = 0, f = 1) : (h = 0, c = 0, d = 1, l = 1, u = 0, f = 1) : _ < A ? (h = 0, c = 0, d = 1, l = 0, u = 1, f = 1) : M < A ? (h = 0, c = 1, d = 0, l = 0, u = 1, f = 1) : (h = 0, c = 1, d = 0, l = 1, u = 1, f = 0);
            var S = M - h + t,
                I = _ - c + t,
                C = A - d + t,
                O = M - l + 2 * t,
    ...
    }, i._buildPermutationTable = e, "undefined" != typeof define && define.amd && define(function() {
        return i
...
function(t) {
    ...
    function e(t, i) {
        this.container = t, this.row = i, this.setup(), this.events(), this.rafLoop();
        var e = this;
        setTimeout(function() {
    ...
    s.setup = function() {
        this.canvas = document.createElement("canvas"), this.canvas.classList.add("nectar-animated-gradient"), this.container.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.onMobile = window.innerWidth < 690, this.orientationChanged = !1, this.clock = 0, this.resolution = this.onMobile ? 90 : 110, this.resPercentage = 100 / this.resolution, this.resPercentageNormalized = this.resPercentage / 100, this.canvas.setAttribute("height", this.resolution), this.canvas.setAttribute("width", this.resolution), this.canvas.style = "width:100%; height: 100%; position: relative;", this.imgdata = this.ctx.getImageData(0, 0, this.canvas.width, this.canvas.height), this.cx = this.canvas.width / 2, this.cy = this.canvas.height / 2, this.data = this.imgdata.data, this.settings = {};
        ...
        if (Object.assign(this.settings, {
            ...
            }, t), this.colorSpeed = 1300 == this.settings.speed ? .5 : .9, this.colors = [], this.settings.color_1 !== this.settings.color_2 && 0 != this.settings.color_2 || (this.singleColor = !0), this.settings.color_1) {
        ...
        var t = this;
        this.trackInView(), window.addEventListener("resize", function() {
            t.onMobile && !t.orientationChanged || t.resize()
        }), window.addEventListener("orientationchange", function() {
            t.orientationChanged = !0
        }), this.resize()
    }, s.resize = function() {
        this.containerW = this.container.clientWidth, this.containerH = this.container.clientHeight;
        ...
        if (this.inView) {
            for (var e = 0; e < this.resolution; e++)
                for (var s = 0; s < this.resolution; s++) {
                    ...
                    this.data[4 * (e + s * this.resolution) + 0] = this.mixed("r", e, s, t), this.data[4 * (e + s * this.resolution) + 1] = this.mixed("g", e, s, t), this.data[4 * (e + s * this.resolution) + 2] = this.mixed("b", e, s, t), this.data[4 * (e + s * this.resolution) + 3] = 265 * t
                }
        ...
        void 0 !== window.vc_iframe || n(), t(window).on("vc_reload", function() {
            n()
        })
    })
}(jQuery);