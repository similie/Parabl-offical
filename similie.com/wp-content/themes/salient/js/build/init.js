! function(t, e, a) {
    ...
    function mt() {
        Le(), pt.usingMobileBrowser || Be(), _n(), Aa(), t("#header-outer .sf-menu > li:not(.megamenu) > ul > li > ul").each(function() {
            ...
            if (t().flexslider) {
                ...
                imagesLoaded(t(this), function() {
                    ...
                    a.flexslider({
                        ...
                        touch: !0,
                        slideshow: n
                    }), t(".flex-gallery .flex-direction-nav li a.flex-next").html('<i class="fa fa-angle-right"></i>'), t(".flex-gallery .flex-direction-nav li a.flex-prev").html('<i class="fa fa-angle-left"></i>'), t(e).trigger("salient-parallax-bg-recalculate"), He()
                })
            }
        })
    }
    ...
    e.nectarState = gt, yt.prototype.setup = function() {
            ...
            if ("horizontal-movement" === this.iconType) e.$el.is('[data-indicator-blur="true"]') && e.$dragEl.addClass("blurred-bg"), e.$el.find(".flickity-viewport").on("mouseenter", function() {
                ...
                e.$el.find(".nectar-post-grid-item").off(), e.$el.find(".nectar-post-grid-item").on("mouseenter", function() {
                    e.activeViewRAF = !0, e.$viewEl.addClass("visible"), e.$viewEl.find("span").text(t(".nectar-post-grid").attr("data-indicator-text")), e.$viewEl.attr("class", function(t, e) {
                        return e.replace(/(^|\s)style-\S+/g, "")
            ...
            t(e).on("nectar-ocm-open", this.setFocus.bind(this)), t(e).on("nectar-ocm-close", this.releaseFocus.bind(this)), this.escCloseEvents()
        ...
        setTimeout(function() {
            t('body[data-ls="magnific"]').length > 0 || t('body[data-ls="pretty_photo"]').length > 0 ? (t("a.pp").removeClass("pp").addClass("magnific-popup"), t("a[rel^='prettyPhoto']:not([rel*='_gal']):not([rel*='product-gallery']):not([rel*='prettyPhoto['])").removeAttr("rel").addClass("magnific-popup"), t(".wpb_gallery .wpb_gallery_slidesnectarslider_style").each(function() {
                ...
                t(".wpb_gallery .wpb_gallery_slidesnectarslider_style").each(function() {
                    ...
                    t(this).parent().is("[href]") && !t(this).parent().is(".magnific-popup") && 0 == t(this).parents(".tiled-gallery").length && 0 == t(this).parents(".product-image").length && 0 == t(this).parents(".woocommerce-product-gallery").length && 0 == t(this).parents(".wpb_gallery_slides.wpb_flexslider").length && 0 == t(this).parents(".iosSlider.product-slider").length && t(this).parent().attr("href").match(/\.(jpg|png|gif)\b/) && t(this).parent().attr("data-fancybox", "")
                }));
    ...
    function ce() {
        r.on("click", ".tabbed > ul li:not(.cta-button) a", function(a) {
            if (function(a) {
                    ...
                    if (a.closest(".tabbed").length > 0 && a.closest(".tabbed").is('[data-style="toggle_button"]') && 3 === n && (n = 2), !a.hasClass("active-tab") && !a.hasClass("loading")) {
                        ...
                        if (t("body.vc_editor").length > 0) {
                            ...
                            a.parents('.tabbed[data-style="toggle_button"]').length > 0 && a.parents("li").index() + 1 === 3 && a.parents(".wpb_tabs_nav").find(".toggle-button[data-m-id]").length > 0 && (l = a.parents(".wpb_tabs_nav").find(".toggle-button").attr("data-m-id")), a.parents(".tabbed").find('> div[data-model-id="' + l + '"]' + i).css({
                                ...
                                opacity: 1
                            }, o).addClass("visible-tab"), r.is('[data-flex-cols="true"]') || ui()
                    ...
                    c.find(".nectar-progress-bar").length > 0 && De(), (c.find('.divider-small-border [data-animate="yes"]').length > 0 || c.find('.divider-border [data-animate="yes"]').length > 0) && Ue(), (c.find("img.img-with-animation").length > 0 || c.find(".col.has-animation").length > 0 || c.find(".nectar_cascading_images").length > 0 || c.find(".wpb_column.has-animation").length > 0) && (Ye(), Re()), (c.find(".parallax-layer").length > 0 || c.parents(".nectar-parallax-enabled").length > 0) && Be(), He(), c.find(".nectar-milestone").length > 0 && le(), c.find('.nectar_image_with_hotspots[data-animation="true"]').length > 0 && (ta(), setTimeout(function() {
                        s.trigger("resize")
                    }, 100)), c.find(".nectar-fancy-ul").length > 0 && xe(), c.find(".nectar-split-heading").length > 0 && Xe(), c.find('.wpb_column[data-border-animation="true"]').length > 0 && Qe(), c.find(".wpb_animate_when_almost_visible").length > 0 && re(), c.find(".nectar-animated-title").length > 0 && ca(), c.find(".nectar-highlighted-text").length > 0 && ha(), c.find(".nectar_food_menu_item").length > 0 && Ge(), c.find('.nectar-post-grid:not([data-animation="none"])').length > 0 && da(), c.find(".nectar-waypoint-el").length > 0 && Ze(), a.parents(".wpb_row").length > 0 && ((c.find(".vc_pie_chart").length > 0 || c.find(".wp-video-shortcode").length > 0 || c.find(".post-area.masonry .posts-container").length > 0 || c.find(".twentytwenty-container").length > 0 || a.parents('#nectar_fullscreen_rows[data-content-overflow="scrollbar"]').length > 0 || a.parents(".tabbed").find("> div:nth-of-type(" + n + ")").find(".wpb_gallery").length > 0 || a.parents(".tabbed").find("> div:nth-of-type(" + n + ")").find(".swiper-container").length > 0 || a.parents(".wpb_row").next().hasClass("parallax_section")) && s.trigger("resize"), c.find(".nectar-flickity").length > 0 && "undefined" != typeof Flickity && a.parents(".tabbed").find("> div:nth-of-type(" + n + ")").find(".nectar-flickity").each(function() {
                        Flickity.data(t(this)[0]).resize()
                    }), c.find(".nectar-woo-flickity").length > 0 && "undefined" != typeof Flickity && (Flickity.data(a.parents(".tabbed").find("> div:nth-of-type(" + n + ")").find(".nectar-woo-flickity > ul")[0]).resize(), t(e).trigger("nectar-product-filters-layout"))), c.find(".svg-icon-holder").each(function(e) {
                        var a = t(this);
                        setTimeout(function() {
                            var t = 0;
                    ...
                    }), 0, a.parent().parent().find(".magic-line").length > 0 && de(a), t(e).trigger("nectar-tab-changed")
                }(t(this)), void 0 !== a.originalEvent && pt.winW < 1e3 && 0 == ut.$usingFullScreenRows) {
            ...
            t(this).find(".wpb_tab").each(function(e) {
                if (t(this).is("[data-tab-icon]") && t(this).attr("data-tab-icon").length > 0 && 0 == t(this).find(".im-icon-wrap.tab-icon").length && (t(this).closest(".tabbed").addClass("using-icons"), t(this).closest(".tabbed").find(".wpb_tabs_nav li:nth-child(" + (e + 1) + ") > a").prepend('<i class="' + t(this).attr("data-tab-icon") + '"></i>')), t(this).find(".im-icon-wrap.tab-icon").length > 0) {
                ...
                e.is('[data-style="minimal_alt"]') && (e.find("> ul").append('<li class="magic-line" />'), de(e.find("> ul > li:first-child > a")))
            }, 100)
        ...
        r.on("click", ".scrolling-tab-nav-current-item", function() {
            t(this).toggleClass("open"), t(this).siblings(".wpb_tabs_nav").toggle(), He()
        ...
        }), a = !1, t(".nectar-sticky-tabs").addClass("loaded"), t(e).on("nectar-tab-changed", ua)
    }
    ...
    function fe() {
        ...
        }, 60), t('.toggle[data-inner-wrap="true"]').length > 0 && s.on("smartresize", pe), t(".toggle > h3:not(.toggle-title)").addClass("toggle-title")
    }
    ...
    function be() {
        ...
        if (t(".nectar-3d-transparent-button").length > 0) {
            ...
            }), ve(), s.on("smartresize", ve), ie(n, "nectar-td-button")
        }
        setTimeout(function() {
    ...
    function We() {
        if (!(pt.usingMobileBrowser && t('body[data-remove-m-parallax="1"]').length > 0)) {
            ...
            t('.nectar-recent-posts-single_featured, [data-n-parallax-bg="true"], .wpb_row.parallax_section, #page-header-bg[data-parallax="1"] .page-header-bg-image-wrap, #page-header-bg[data-parallax="1"] .nectar-video-wrap, .parallax_slider_outer .nectar-slider-wrap').each(function() {
                t(this).is("[data-n-parallax-bg][data-parallax-speed]") ? (R[e] = new ze(t(this), ".parallax-layer", Me(t(this).attr("data-parallax-speed")), "regular"), e++) : 0 == t(this).find('[data-parallax-speed="fixed"]').length && (t(this).hasClass("nectar-slider-wrap") ? R[e] = new ze(t(this), ".video-wrap, .image-bg", .25, "nectar-slider") : t(this).hasClass("page-header-bg-image-wrap") ? R[e] = new ze(t(this), ".page-header-bg-image", .25, "page-header") : t(this).hasClass("nectar-video-wrap") && t(this).parents("#page-header-bg").length > 0 ? R[e] = new ze(t(this), ".nectar-video-bg", .25, "page-header") : R[e] = new ze(t(this), ".row-bg.using-image", Me(t(this).find(".row-bg").attr("data-parallax-speed")), "regular"), e++), t(this).addClass("nectar-parallax-enabled")
    ...
    function Je() {
        t(".nectar_image_with_hotspots").each(function() {
            t(this).find(".nectar_hotspot_wrap").each(function() {
                ...
                } else t(this).find(".nttip").removeClass("force-left").removeClass("force-right").removeClass("force-top"), t(this).find(".nectar_hotspot").addClass("click"), 0 == t(this).find(".nttip a.tipclose").length && t(this).find(".nttip .inner").append('<a href="#" class="tipclose"><span></span></a>'), t(".nttip").css("height", s.height())
            })
        })
    }
    ...
    function ia() {
        ...
        if ("IntersectionObserver" in e) {
            s.off("resize.nectarLazySizing", sa), s.on("resize.nectarLazySizing", sa), ct = new IntersectionObserver(function(t) {
    ...
    function oa() {
        nt = [], ra(), t(".nectar-post-grid-wrap").each(function(e) {
            nt[e] = new la(t(this))
        })
    }
                    ...
                    handler: function() {
                        if (a.parents(".wpb_tab").length > 0 && "hidden" == a.parents(".wpb_tab").css("visibility") || a.hasClass("completed")) n.destroy();
                            ...
                            a.find(".nectar-post-grid__reveal-image__inner").length > 0 && a.find(".nectar-post-grid__reveal-image__inner").css({
                                ...
                                var n = t(this);
                                setTimeout(function() {
                                    n.addClass("animated-in"), "zoom-out-reveal" === i && Hn(n, function() {
                                        Sn(n)
                                    })
                                }, a * e)
                            }), setTimeout(function() {
    ...
    function fa() {
        G = [], "undefined" != typeof NectarTestimonialSlider ? t(".testimonial_slider").each(function(e) {
            ...
            G[e] = new NectarTestimonialSlider(a, n, ka, Le), t(this).is('.disable-height-animation:not([data-style*="multiple_visible"])') && (G[e].testimonialSliderHeight(), setTimeout(G[e].testimonialSliderHeight.bind(G[e]), 700)), t(this).is('.testimonial_slider[data-style="multiple_visible_minimal"]') && G[e].testimonialSliderHeightMinimalMult()
        }) : Nt("#nectar-testimonial-sliders-js", 0, fa)
    }

    function ga() {
        s.off("smartresize.nectarTestimonials"), s.off("resize.nectarTestimonialsMin"), G.length > 0 && s.on("smartresize.nectarTestimonials", ma), t('.testimonial_slider[data-style="multiple_visible_minimal"]').length > 0 && s.on("resize.nectarTestimonialsMin", va)
    }
    ...
    function $a() {
        ...
        0 == t(".nectar-video-wrap").length && 0 == t(".nectar-youtube-bg").length || (setTimeout(function() {
            ka(), s.on("resize", ka), e.addEventListener("orientationchange", function() {
                this.setTimeout(function() {
                    ka()
                }, 100)
                ...
                if (0 != t(this).find("video").length) {
                    ...
                    if (0 === t(this).find("video.nectar-lazy-video").length) var n = setInterval(function() {
                        a.find("video").get(0).readyState > 3 && (pt.usingMobileBrowser || (a.transition({
                            ...
                            opacity: "0.7"
                        }, 400), 1 == e && Za()), p.addClass("loaded"), setTimeout(function() {
                            p.addClass("hidden")
                        }, 1e3), clearInterval(n))
                    }, 60);
                    pt.usingMobileBrowser && (a.parents(".full-width-section").length > 0 && 0 == a.parents("#nectar_fullscreen_rows").length && !a.hasClass("column-video") ? a.css("left", "50%") : a.css("left", "0px"), 1 == e && Za(), a.find("video")[0].onplay = function() {
                        a.transition({
                            opacity: "1"
                        }, 400), a.find("video").transition({
                            opacity: "1"
    ...
    function Ia() {
        if (t('body.material[data-slide-out-widget-area-style="slide-out-from-right"]').length > 0 && (Oa(), u.length > 0)) {
            var a = u.detach();
    ...
    function Aa() {
        pt.winW < 1e3 || t("body > #boxed").length > 0 || t(".ocm-effect-wrap-inner > #boxed").length > 0 ? (t("#slide-out-widget-area.fullscreen .off-canvas-social-links, #slide-out-widget-area.fullscreen-alt .off-canvas-social-links").appendTo("#slide-out-widget-area .inner"), t("#slide-out-widget-area.fullscreen .bottom-text, #slide-out-widget-area.fullscreen-alt .bottom-text").appendTo("#slide-out-widget-area .inner")) : (t("#slide-out-widget-area.fullscreen .off-canvas-social-links,#slide-out-widget-area.fullscreen-alt .off-canvas-social-links").appendTo("#slide-out-widget-area .inner-wrap"), t("#slide-out-widget-area.fullscreen .bottom-text, #slide-out-widget-area.fullscreen-alt .bottom-text").appendTo("#slide-out-widget-area .inner-wrap")), t(".slide-out-from-right.open .off-canvas-menu-container.mobile-only").length > 0 && 0 == t("body.mobile").length && t("#slide-out-widget-area .slide_out_area_close").trigger("click"), Ha()
    }

    function Ma() {
        if (Ea(), pt.usingMobileBrowser && t("#slide-out-widget-area.open").length > 0 || t(".slide-out-from-right-hover.ios-ocm-style").length > 0 && t("#slide-out-widget-area.open").length > 0) return Ba(), !1;
        (pt.usingMobileBrowser || t(".slide-out-from-right-hover.ios-ocm-style").length > 0) && (t(".slide-out-widget-area-toggle a").attr("aria-expanded", "true"), l.css({
            ...
            transform: "translate3d(0,0,0)"
        }).addClass("open"), Sa(), t(".slide-out-from-right-hover.ios-ocm-style").length > 0 && setTimeout(function() {
        ...
        if (t(".slide-out-hover-icon-effect .lines-button").removeClass("no-delay").addClass("unhidden-line"), 0 == t('#header-outer[data-permanent-transparent="1"]').length && 0 == t("#nectar_fullscreen_rows").length && !pt.usingFrontEndEditor && pt.winW > 1e3 && (0 == pt.scrollTop && t("#header-outer.transparent").length > 0 || 0 == t("body.mobile").length && dt && (d.attr("data-transparent", "true").addClass("no-bg-color").addClass("slide-out-hover"), t("#header-outer header, #header-outer > .cart-outer").addClass("all-hidden")), 0 == t('#header-outer[data-remove-fixed="1"]').length && 0 == t("body.mobile").length && dt && (1 == k ? (s.off("scroll", gn), s.off("scroll", fn)) : (s.off("scroll", mn), s.off("scroll", vn)))), pt.usingMobileBrowser) return !1;
    ...
    function Wa(a) {
        var n = s.width(),
            ...
            r = Ut();
        pt.winW < 1e3 && (r = !0);
        ("left" !== (e.nectarOptions && e.nectarOptions.mobile_header_format && "centered-menu" === e.nectarOptions.mobile_header_format && r ? "left" : "right") && "left" !== A ? a.clientX < n - parseInt(i) - b : a.clientX > parseInt(i) + b) && o.hasClass("mouse-accessed") && (o.removeClass("mouse-accessed"), s.off("mousemove.rightOffsetCheck", Wa), o.css({
            transform: ""
            ...
            duration: 250,
            easing: "easeOutCubic"
        })) : s.on("scroll.headerResizeEffect", gn)) : (s.off("scroll.headerResizeEffectOpaque"), s.on("scroll.headerResizeEffectOpaque", mn)))))
    }
    ...
    function ja() {
        if (r.on("click", ".slide-out-widget-area-toggle:not(.std-menu) a.closed.animating", function() {
                ...
                var a = 700;
                return gt.ocmOpen = !0, Sa(), d.removeClass("no-transition"), t(this).hasClass("simple-mobile-menu") ? (La("simple-mobile-menu"), t(this).find("a").addClass("open"), !1) : (o.hasClass("slide-out-from-right") ? function() {
                    ...
                    if (0 == t("body.material").length) {
                        ...
                        0 == t('#header-outer[data-remove-fixed="1"]').length && pt.winW > 1e3 && (1 == dt && 1 == k && "true" == d.attr("data-transparent-header") ? (d.stop(!0).transition({
                            y: "0"
                        }, 0).addClass("transparent").css("transition", "transform"), s.off("scroll", gn), s.off("scroll", fn)) : 1 == dt && "true" == d.attr("data-transparent-header") && (d.addClass("transparent"), s.off("scroll", mn), s.off("scroll", vn)))
                    ...
                    }, e), t("#slide-out-widget-area.fullscreen").show().addClass("open"), 0 == t(".nectar-social.fixed").length && Dn(), t(".container-wrap").addClass("no-shadow"), d.stop(!0).css("transform", "translateY(0)"), setTimeout(function() {
                    ...
                    }, 50 + a), Aa(), t('.mobile #header-outer[data-permanent-transparent="false"]').length > 0 && t(".container-wrap").hasClass("no-scroll") && t("#ajax-content-wrap").addClass("at-content");
                    ...
                    o.hasClass("fullscreen-split") && (e = ".fullscreen-split"), t("body.material").length > 0 && t("header#top .slide-out-widget-area-toggle a").addClass("menu-push-out"), t("header#top .slide-out-widget-area-toggle:not(.std-menu) .lines-button:not(.legacy-double)").addClass("close"), ".fullscreen-alt" === e ? t("#slide-out-widget-area" + e).show().addClass("open") : t("#slide-out-widget-area" + e).addClass("open").removeClass("hidden"), l.addClass("open").removeClass("hidden"), t('body > div[class*="body-border"]').css("z-index", "9995"), ".fullscreen-alt" === e && t(".off-canvas-menu-container .menu").transition({
                        y: "0px",
                        opacity: 1
                    }, 0), 0 == t(".nectar-social.fixed").length && Dn(), t("#header-outer.transparent").length > 0 && f.length > 0 && (t(".admin-bar #slide-out-widget-area-bg" + e).css({
                ...
                }(), a = 1100) : t("#header-outer #mobile-menu").length > 0 && (a = 150, La("slide-out-widget-area-toggle")), gt.ocmAnimating = !0, setTimeout(function() {
                    gt.ocmAnimating = !1
                ...
                var n;
                if (null != a.originalEvent || 0 != t(".slide_out_area_close.non-human-allowed").length || 0 != t(".slide-out-widget-area-toggle.mobile-icon a.non-human-allowed").length) return !(gt.ocmAnimating || t(".slide-out-widget-area-toggle:not(.std-menu) a.animating").length > 0) && (gt.ocmOpen = !1, d.removeClass("no-transition"), t(this).parents(".simple-mobile-menu").length > 0 ? (qa("simple-mobile-menu"), t(this).removeClass("open"), !1) : (t(".slide-out-widget-area-toggle:not(.std-menu):not(.simple-mobile-menu) a").removeClass("open").addClass("closed").attr("aria-expanded", "false"), t(".slide-out-widget-area-toggle:not(.simple-mobile-menu):not(.std-menu) a").addClass("animating"), o.hasClass("slide-out-from-right") ? function() {
                    if (0 == t("body.material").length) {
                        var a = Ut();
                        pt.winW < 1e3 && (a = !0);
                        var n = e.nectarOptions && e.nectarOptions.mobile_header_format && "centered-menu" === e.nectarOptions.mobile_header_format && a ? "left" : "right";
                    ...
                    0 == t(".nectar-social.fixed").length && Nn(), t(".container-wrap").removeClass("no-shadow")
                ...
                }, ".fullscreen-inline-images" == n ? 0 : 100)) : t("#header-outer #mobile-menu").length > 0 && qa("slide-out-widget-area-toggle"), 0 == t("#header-outer #mobile-menu").length && (t("#header-outer.temp-removed-dark-slide.transparent").length > 0 && 0 == t("#boxed").length && d.removeClass("temp-removed-dark-slide").addClass("dark-slide"), 0 == t('#header-outer[data-permanent-transparent="1"]').length && 0 == t("#slide-out-widget-area.fullscreen-alt").length && (0 == t(".nectar-box-roll").length ? (t("#header-outer.small-nav").length > 0 || t("#header-outer.scrolled-down").length > 0) && d.removeClass("transparent") : (t("#header-outer.small-nav").length > 0 || t("#header-outer.scrolled-down").length > 0 || t(".container-wrap.auto-height").length > 0) && d.removeClass("transparent")), d.removeClass("hidden-menu"), d.removeClass("side-widget-open").addClass("side-widget-closed")), t(e).trigger("nectar-ocm-close"), !1))
            ...
            var n = Pa(a);
            t(".nectar-ocm-image." + n).length > 0 && (t(".nectar-ocm-image.default").remove(), t(".nectar-ocm-image." + n).addClass("current")), t(".off-canvas-menu-container .menu > .menu-item-has-children > a").on("click", function(e) {
    ...
    function Ya() {
        e.nectarOptions && "1" === e.nectarOptions.simplify_ocm_mobile && pt.usingMobileBrowser && o.hasClass("slide-out-from-right") && t("body.material").length > 0 && (t("body").attr("data-slide-out-widget-area-style", "slide-out-from-right-hover"), o.removeClass("slide-out-from-right"), o.addClass("slide-out-from-right-hover").addClass("ios-ocm-style"), t("#slide-out-widget-area .inner > .widget").wrapAll('<div class="bottom-meta-wrap"></div>')), t("#slide-out-widget-area.slide-out-from-right-hover").length > 0 ? function() {
            ...
            if (0 == t("#ajax-content-wrap > .slide-out-widget-area-toggle").length) {
                ...
                0 === t(".ios-ocm-style").length && t('<div class="slide-out-widget-area-toggle slide-out-hover-icon-effect" data-icon-animation="simple-transform"><div> <a href="#sidewidgetarea" role="button" class="closed"> <span> <span class="screen-reader-text">' + nectar_front_i18n.menu + '</span> <i class="lines-button x2" role="none"> <i class="lines"></i> </i> </span> </a> </div> </div>').insertAfter(a), (t('#header-outer[data-has-menu="true"]').length > 0 || t('body[data-header-search="true"]').length > 0 || t(".slide-out-widget-area-toggle a.using-label").length > 0 || t('.slide-out-widget-area-toggle[data-custom-color="true"]').length > 0) && t(".slide-out-widget-area-toggle").addClass("small")
            }
            pt.usingMobileBrowser || 0 != t(".ios-ocm-style").length ? (r.on("click", ".slide-out-widget-area-toggle:not(.std-menu) a", function(t) {
                e && (Ma(), e = !1, setTimeout(function() {
                    e = !0
                }, 350)), t.preventDefault()
            }), r.on("click", "#slide-out-widget-area-bg", Fa), r.on("click", ".ios-ocm-style .slide_out_area_close", function(t) {
                Fa(), t.preventDefault()
            })) : (r.on("mouseenter", "#header-outer .slide-out-widget-area-toggle:not(.std-menu) a", Ma), o.on("mouseenter", function() {
                t(this).addClass("mouse-accessed")
            })), s.on("smartresize", Ea)
        }() : (ja(), 0 != t("#header-outer #mobile-menu").length && (t("#header-outer #mobile-menu li.megamenu").removeClass("megamenu"), t("#header-outer #mobile-menu ul li a").each(function() {
    ...
    oe.prototype.setup = function() {
        ...
        "single_link" == this.linkFunc && (t(e).on("resize", this.setVertCenter.bind(this)), this.setVertCenter(), this.$el.find(".wpb_tabs_nav li").on("click", function(e) {
            if (pt.winW < 1e3) {
                ...
                void 0 !== e.originalEvent && (a.$el.find(".scrolling-tab-nav .scrolling-tab-nav-current-item").toggleClass("open"), n.toggle(), He()), a.$el.find(".scrolling-tab-nav li").removeClass("active"), t(this).addClass("active"), a.updateActiveTitle()
            }
        }))
        ...
        if (this.offsetTop + 150 + this.height < pt.scrollTop || this.offsetTop - 150 > pt.scrollTop + this.storedWinH || 1 == gt.materialOffCanvasOpen) {
            ...
            for (t = 0; t < this.$parallaxEl.length; t++) !0 === this.firstSection ? this.$parallaxEl[t].style.transform = "translate3d(0, " + parseInt(pt.scrollTop * this.speed) + "px, 0)" : this.$parallaxEl[t].style.transform = "translate3d(0, " + parseInt((this.storedWinH + pt.scrollTop - this.offsetTop) * this.speed) + "px, 0) scale(1.005)", this.$parallaxEl[t].style.willChange = "transform";
            requestAnimationFrame(this.update.bind(this))
        }
    }, t(e).on("salient-parallax-el-recalculate", He), Se.prototype.setupProps = function() {
        var t = JSON.parse(this.$el[0].getAttribute("data-nectar-animate-settings"));
        "function" == typeof Object.assign && (Object.assign(this.animations, t.animations), Object.assign(this.offsets, t.offsets), Object.assign(this, t.config)), (this.$el.is(".top-level") || this.$el.parents(".top-level").length > 0 || pt.usingFrontEndEditor && 1 === this.$el.parents(".vc_element").last().index()) && (this.topLevel = !0)
    ...
    }, t(e).on("salient-parallax-bg-recalculate", Be), Ve.prototype.calculatePos = function() {
    ...
    }, t(e).on("salient-lazyloading-image-reinit", ia), t(e).on("salient-lazyloading-image-reinit", sa), la.prototype.initialMarkup = function() {
        ...
        this.el.find(".nectar-post-grid-filters a, .load-more-wrap .load-more").on("click", function(r) {
            ...
            "rand" == n.orderby && "load-more" == c && (f.posts_shown = "", l.find(".nectar-post-grid-item[data-post-id]").each(function() {
                ...
                be(), l.is("[data-animation]") && !l.is('[data-animation="none"]') && (o.parents(".nectar-post-grid-wrap").removeClass("finished-animating"), l.find(".nectar-post-grid-item:not(.animated-in)").each(function(e) {
                    t(this).find(".nectar-split-heading").length > 0 && An(t(this).find(".nectar-split-heading"));
                    var n = t(this);
                    setTimeout(function() {
                        n.addClass("animated-in"), "zoom-out-reveal" === a.animation && Hn(n, function() {
                            Sn(n)
                        })
                    }, 90 * e)
                }), setTimeout(function() {
            ...
            this.$trigger.on("click.menu", function() {
                ...
                if (t(".fullscreen-alt .off-canvas-menu-container .clip-wrap, .fullscreen-alt .off-canvas-menu-container .clip-wrap span").css("transition-duration", "0s"), i.length > 0) {
                    ...
                    return setTimeout(function() {
                        ...
                        height: s.height()
                    }, 500, "easeInOutQuad"), setTimeout(Aa, 600), !1
                }
                ...
                return setTimeout(function() {
                    ...
                    }, 500, "easeInOutQuad"), setTimeout(Aa, 600)
                }, 50), !1
            })
        },
        closeMenu: function() {
    ...
    function Qa() {
        ...
        if (t('#page-header-bg[data-parallax="1"]').length > 0) {
            ...
            c && -1 !== c.indexOf(".") ? (r.onload = function() {
                Da()
            }, r.src = Jt(t('#page-header-bg[data-parallax="1"]').css("background-image"))) : Da(), pt.winW > 1e3 && p(), e.addEventListener("scroll", function() {
        ...
        if (g.length > 0) {
            ...
            u && -1 !== u.indexOf(".") && g.addClass("has-bg"), s.on("smartresize", Na)
        }
        ...
        g.length > 0 && ((-1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome") || navigator.userAgent.match(/(iPod|iPhone|iPad)/)) && (e.onunload = function() {
            Qa(), t('#page-header-bg[data-parallax="1"] .span_6').css({
                opacity: 1
            })
    ...
    function Ja() {
        t(".nectar-box-roll").length > 0 && "undefined" != typeof NectarBoxRoll && (Ga(), t(e).on("nectar-box-roll-scroll-disabled", function() {
            gt.preventScroll = !0
    ...
    function Ka() {
        ...
        a = 1 == lt ? "500%" : "93%", i = 1 == lt ? "500%" : "95%", t(ot + '.row-bg-wrap[data-bg-animation]:not([data-bg-animation="none"]) .row-bg').each(function() {
            ...
            }), Ye(), De(), Ue(), h = 1 == lt ? "250%" : "75%", t(ot + '.nectar-icon-list[data-animate="true"]').each(function() {
                var e = t(this),
                    a = new Waypoint({
                        element: e[0],
                        handler: function() {
            ...
            }), ca(), ha(), ta(), u = 1 == lt ? "200%" : "95%", t(ot + ".clients.fade-in-animation").each(function() {
                var e = t(this),
                    a = new Waypoint({
                        element: e[0],
                        handler: function() {
            ...
            }), Xe(), p = 1 == lt ? "500%" : "bottom-in-view", 0 == W.length || pt.usingFrontEndEditor && t("#nectar_fullscreen_rows").length > 0 ? (t(".svg-icon-holder:not(.animated-in)").has("svg").each(function(e) {
                var a = t(this);
            ...
            function() {
                if (t(".nectar-milestone").each(function() {
                    ...
                    }), ie(e, "milestone-blur"), le()
                }
            }(), xe(), t(ot + '.owl-carousel[data-enable-animation="true"]').each(function() {
            ...
            function() {
                if (t('body[data-header-inherit-rc="true"]').length > 0 && 0 == t(".mobile").length && t('#header-outer[data-transparent-header="true"]').length > 0) {
                    ...
                    0 == t('#header-outer[data-permanent-transparent="1"]').length && (e = w - _ + Math.ceil(2 * y / 1.8) + pt.adminBarHeight), t(".main-content > .row > .wpb_row").each(function() {
                        var a, n = t(this);
                        new Waypoint({
                            element: n[0],
                            handler: function(e) {
    ...
    function tn() {
        var a;
        wt(), Ct(), setTimeout(xt, 100), It(), Ht(), Wt(), Ft(), qt(), fe(), r.on("click", ".toggle > h3 a, .toggle > .toggle-title a", function() {
            ...
            }), we(), wa(), be(), r.on("click", '.nectar-cta:not([data-style="material"]) .link_wrap', function(e) {
                ...
                if (!(t(".nectar_team_member_overlay").length > 0)) {
                    ...
                    t(".nectar_team_member_overlay .inner-wrap").css({
                        "padding-top": u
                    }), t(".using-mobile-browser").length > 0 && t("body,html").addClass("nectar-no-scrolling"), ye(), t(".nectar_team_member_overlay").addClass("open").addClass("animating"), setTimeout(function() {
                        t(".nectar_team_member_close").addClass("visible"), t(".nectar_team_member_overlay").removeClass("animating")
                    }, 500), t('.team-member[data-style="bio_fullscreen"]').length > 0 && pt.usingMobileBrowser && t(".nectar_team_member_overlay").addClass("on-mobile"), Ca(), t(e).trigger("nectar-team-member-opened")
                }
            ...
            }), (t('.team-member[data-style="bio_fullscreen"]').length > 0 || t('.team-member[data-style="bio_fullscreen_alt"]').length > 0) && (s.on("resize", ye), !pt.usingMobileBrowser)) && new yt("", "close-indicator"), t(".nectar-flip-box").length > 0 && (pt.usingMobileBrowser && r.on("click", ".nectar-flip-box", function() {
                t(this).toggleClass("flipped")
            }), $e(), s.on("smartresize", $e)), St(), qe(), je(), ke(), jn(), Yn(), Pe(), t(".morphing-outline").length > 0 && (setTimeout(Ce, 100), setTimeout(Le, 125), s.on("smartresize", Ce)), j = [], pt.usingMobileBrowser || t("[data-nectar-link-indicator]").each(function(e) {
                j[e] = new yt(t(this), "link-indicator")
            }), oa(), t(".nectar_cascading_images").length > 0 && (V = [], t(".nectar_cascading_images").each(function(e) {
                imagesLoaded(t(this), function(a) {
                    Re(), t(a.elements[0]).is('[data-parallax="yes"]') && !pt.usingMobileBrowser && 0 == t("#nectar_fullscreen_rows").length && (V[e] = new Ve(t(a.elements[0]), t(a.elements[0]).attr("data-parallax-intensity")))
                })
            }), s.on("resize", Re)), Ke(), pa(),
            function() {
            ...
            }(), Ln(), qn(), Vn(), r.on("mouseover", '.post-area.featured_img_left .grav-wrap .text a, .masonry.material .masonry-blog-item .grav-wrap .text a, .blog-recent[data-style="material"] .grav-wrap .text a', function() {
            ...
            }(), Mn(), t(".nectar-scrolling-text").each(function() {
    ...
    function sn() {
        ...
        if (t("#header-outer .nectar-woo-cart").length > 0 && t("#header-outer .nectar-woo-cart").hoverIntent(function() {
            ...
            }), r.on("added_to_cart", o)), 0 == t('#header-outer[data-cart="false"]').length && (i = setInterval(o, 250), setTimeout(function() {
                clearInterval(i)
            }, 4500)), function() {
                if (0 != t("body.woocommerce-account #customer_login").length) {
                    t(".woocommerce-account .woocommerce > #customer_login").prepend('<div class="nectar-form-controls" />'), t(".woocommerce-account .woocommerce > #customer_login > div:not(.nectar-form-controls)").each(function() {
        ...
        if (t(".products .classic .product-wrap .add_to_cart_button").wrapInner("<span />"), t(".products .classic .product-wrap .add_to_cart_button").prepend('<i class="normal icon-salient-cart"></i>'), !(t('.products[data-rm-m-hover="1"]').length > 0 && pt.usingMobileBrowser) && e.nectarOptions && e.nectarOptions.woo_minimal_product_effect && "default" === e.nectarOptions.woo_minimal_product_effect && (r.on("mouseover", ".products .minimal.product", function() {
                ...
                return t(".nectar-slide-in-cart, .nectar-slide-in-cart-bg").addClass("open"), t(".nectar-slide-in-cart-bg").addClass("revealed"), clearTimeout(Va), t(".style_slide_in_click div.quantity").each(function() {
                    t(this).find(".minus").length > 1 && t(this).find(".minus").first().remove(), t(this).find(".plus").length > 1 && t(this).find(".plus").first().remove()
                }), !1
            }), r.on("click", ".nectar-slide-in-cart.style_slide_in_click .close-cart, .nectar-slide-in-cart-bg", rn), new an, e.nectarOptions && "1" === e.nectarOptions.ajax_add_to_cart) new nn;
        if (e.nectarOptions && "1" === e.nectarOptions.woo_product_filter_toggle && r.is(".archive.woocommerce")) new en;
        t(a).on("yith-wcan-ajax-filtered", ia)
    }

    function rn() {
        return t(".nectar-slide-in-cart, .nectar-slide-in-cart-bg").removeClass("open"), Va = setTimeout(function() {
    ...
    t.fn.dlmenu = function(e) {
        ...
        clearTimeout(this.ajaxTimeout), this.ajaxTimeout = setTimeout(function() {
            i.$qty.closest(".widget_shopping_cart_content").addClass("loading"), i.$qty.closest(".woocommerce-mini-cart-item").addClass("blockUI").addClass("blockOverlay"), t.ajax({
                type: "POST",
                ...
                success: function(n) {
                    if (n) {
                        ...
                        s.find(".woocommerce-Price-amount, .tax_label").remove(), s.append(n.subtotal), !0 === i.state.removeFlag && (i.$qty.closest(".woocommerce-mini-cart-item").remove(), i.state.removeFlag = !1, t(a.body).trigger("updated_wc_div")), t("#header-outer a.cart-contents .cart-wrap span").length > 0 && t("#header-outer a.cart-contents .cart-wrap span").text(n.item_count)
                    }
                }
            })
        }, this.ajaxTimeoutDur)
    ...
    function pn() {
        ...
        un.bodyOffsetHeight = a.body.offsetHeight, 0 == un.init && setInterval(function() {
            1 != gt.materialOffCanvasOpen && (un.bodyOffsetHeight = a.body.offsetHeight)
        }, 1500), un.raf = requestAnimationFrame(function a() {
            d[0].classList.add("detached");
            var o = pt.scrollTop,
                l = Math.abs(o - e);
            if (1 == gt.animatedScrolling || 1 == gt.preventScroll || 1 == gt.ocmOpen) return o > n && (1 == gt.animatedScrolling && 1 == $ && 0 == gt.permanentTransHeader && d.removeClass("transparent").addClass("scrolling"), e = pt.scrollTop, o = pt.scrollTop), void(un.raf = requestAnimationFrame(a));
            if (1 == gt.materialOffCanvasOpen || 1 == gt.materialSearchOpen) return 1 == gt.materialSearchOpen && 1 == $ && (0 == gt.permanentTransHeader && o > n ? d.removeClass("transparent").addClass("scrolling") : d.addClass("transparent").removeClass("scrolling")), void(un.raf = requestAnimationFrame(a));
            if (!d.hasClass("side-widget-open") && !t("#header-outer .slide-out-widget-area-toggle a").hasClass("animating")) {
                var h;
                if (c.length > 0 && (o > n ? (c.addClass("hide-up"), d.css("transform", "translateY(-" + pt.secondaryHeaderHeight + "px)")) : (c.removeClass("hide-up"), d.css("transform", "0px)"))), o > n) 0 == gt.permanentTransHeader && (0 == un.timeoutQueued && setTimeout(function() {
                    0 == gt.ocmOpen && (d.removeClass("transparent"), d.addClass("scrolling")), un.timeoutQueued = !1
                }, 400), un.timeoutQueued = !0), d.removeClass("no-transition"), l >= s && (o > e ? (d.hasClass("invisible") || (d.addClass("invisible").removeClass("at-top"), pt.winW > 1e3 && t(".sf-menu").length > 0 && t().superfish && (t(".sf-menu").superfish("hide"), t("header#top nav > ul.sf-menu > li.menu-item-over").removeClass("menu-item-over"))), 1 == r && t(".page-submenu.stuck").css("transform", "translateY(0px)").addClass("header-not-visible")) : (d.hasClass("invisible") && d.removeClass("invisible"), 1 == r && (h = d.outerHeight(), c.length > 0 && (h -= pt.secondaryHeaderHeight), f.length > 0 && pt.winW > 999 ? (i = dt ? f.height() : 0, t(".page-submenu.stuck").css("transform", "translateY(" + (h - i) + "px)").removeClass("header-not-visible")) : t(".page-submenu.stuck").css("transform", "translateY(" + h + "px)").removeClass("header-not-visible"))));
                else {
                ...
                pt.winH + pt.scrollTop + 30 >= un.bodyOffsetHeight && (d.removeClass("invisible"), 1 == r && (h = d.outerHeight(), c.length > 0 && (h -= pt.secondaryHeaderHeight), f.length > 0 && pt.winW > 999 ? (i = dt ? f.height() : 0, t(".page-submenu.stuck").css("transform", "translateY(" + (h - i) + "px)").removeClass("header-not-visible")) : t(".page-submenu.stuck").css("transform", "translateY(" + h + "px)").removeClass("header-not-visible")))
            }
    ...
    function kn() {
        (t('body[data-footer-reveal="1"]').length > 0 || t('body.material[data-slide-out-widget-area-style="slide-out-from-right"]').length > 0) && (setTimeout(xn, 60), xn(), s.on("resize", xn), t('body[data-footer-reveal="1"][data-footer-reveal-shadow="large_2"]').length > 0 && t(".container-wrap").css({
    ...
    function In() {
        ...
        }), (a > 0 || navigator.userAgent.match(/Trident.*rv\:11\./)) && (En(), t(e).on("resize", En))
    }
    ...
    function Wn() {
        if (t(".nectar-recent-posts-slider-inner").length > 0) {
            ...
            }), On(), s.on("resize", On), pt.usingMobileBrowser || pt.usingFrontEndEditor || s.on("resize", Fn)
        }
    ...
    function Ln() {
        Wn(), t('.blog-recent[data-style="classic_enhanced_alt"] .inner-wrap').each(function() {
        ...
        }), pt.usingMobileBrowser || t(".nectar-recent-posts-slider").length > 0 && !pt.usingFrontEndEditor && e.requestAnimationFrame(Bn), pt.usingMobileBrowser || pt.usingFrontEndEditor || Fn()
    }
    ...
    function Xn() {
        t(".infinite_scroll").length > 0 && (t(".portfolio-items.infinite_scroll").infinitescroll({
            ...
            t(e).css("opacity", 0).imagesLoaded(function() {
                ...
                if (t(e).find(".work-item.style-5").length > 0 && qn(), "none" == t(e).find(".inner-wrap").attr("data-animation")) t(".portfolio-items .col .inner-wrap").removeClass("animated");
                else {
    ...
    function Nn() {
        ...
        }, 350, "easeInOutCubic"), s.off("scroll", Nn), s.on("scroll", Dn))
    }
    ...
    function Dn() {
        if (pt.scrollTop < 350 || o.is(".fullscreen.open")) {
            ...
            }, e, "easeInOutQuint"), s.off("scroll", Dn), s.on("scroll", Nn)
        }
    }

    function Qn() {
        if (0 == t(".nectar-social.fixed").length && (t("#to-top").length > 0 && pt.winW > 1020 || t("#to-top").length > 0 && t("#to-top.mobile-enabled").length > 0) && (pt.scrollTop > 350 ? s.on("scroll", Dn) : s.on("scroll", Nn)), t('body[data-button-style*="rounded"]').length > 0) {
    ...
    function Gn() {
        ...
        if (n && (o = (o = n.split("/")).length), n && o > 1 && (n = n.replace(/\//g, ""), a = a.replace(/\//g, "")), a && t(".main-content").find(a).length > 0 || a && t(".main-content").find('[data-fullscreen-anchor-id="' + n + '"]').length > 0) {
            ...
            var u = 100;
            t(".nectar-box-roll").length > 0 && t(".container-wrap.bottomBoxOut").length > 0 && (ht.boxRoll(null, -1), u = 2050), t("img[data-nectar-img-src]").length > 0 && (ea(), u = 200), setTimeout(function() {
                var e;
                if (!0 === E) {
    ...
    function Un() {
        ...
        t(".portfolio-items:not(.carousel)").each(function(a) {
            if (t(this).attr("instance", a), t(this).parent().parent().find("div[class^=portfolio-filters]").attr("instance", a), "undefined" != typeof SalientPortfolio) M[e] = new SalientPortfolio(t(this), Le, ot, Ie), e++;
            else {
                var n = t(this);
    ...
    function Jn() {
        pt.winW > 690 && t('.posts-container[data-load-animation="perspective"]').css("perspective-origin", "50% " + (pt.scrollTop + pt.winH) + "px"), requestAnimationFrame(Jn)
    }
    ...
    function ni() {
        ...
        if (t(".nectar-sticky-column-css").each(function() {
                t(this).hasClass("n-sticky-initialized") || (0 == t(this).find(".n-sticky").length && t(this).wrapInner('<div class="n-sticky" />'), t(this).addClass("n-sticky-initialized"), t(this).hasClass("nectar-sticky-column-css--middle") && new ge(t(this)))
    ...
    function si() {
        if (t("#nectar_fullscreen_rows").length > 0 && t().fullpage) {
            ...
            pt.usingMobileBrowser || (a = "off"), "on" != a ? lt = !0 : ot = "", "undefined" != typeof NectarFullScreenRows && (ut = new NectarFullScreenRows(Ka, U, ii, pt, Je, K, W, tt))
    ...
    function li() {
        var a = pt.winW,
            n = pt.winH,
            i = 0;
        r.is('[data-flex-cols="true"]') || t('[class*="vc_col-xs-"], [class*="vc_col-md-"], [class*="vc_col-lg-"]').length > 0 && (oi(), pt.usingMobileBrowser ? (e.addEventListener("orientationchange", function() {
            i = 1
        }), s.on("resize", function() {
            (s.width() != a && s.height != n || 1 === i) && (oi(), a = pt.winW, n = pt.winH, i = 0)
        })) : s.on("resize", oi))
    }
    ...
    function pi() {
        setTimeout(function() {
            t("body.compose-mode").length > 0 && t(".container-wrap").addClass("visible-editor-controls"), pt.usingFrontEndEditor && (hi(), r.is('[data-flex-cols="true"]') || (ui(), s.on("smartresize", ui)))
        }, 200), s.on("vc_reload", function() {
            if (hi(), _e(), be(), It(), Be(), wt(), fe(), je(), ke(), jn(), ya(), qt(), oa(), Mn(), Yn(), Pe(), ia(), t(".carousel").length > 0 && (Ht(), Ft(), Bt()), t(".owl-carousel").length > 0 && (t(".owl-carousel").each(function() {
            ...
            for (a = 0; a < G.length; a++) "multiple_visible" != G[a].type && "multiple_visible_minimal" != G[a].type || (G[a].flickityEl.flickity("reloadCells"), G[a].flickityEl.off("select.flickity"), fa(), G[a].flickityEl.resize()), G[a].testimonialSliderHeight();
            if (ga(), pa(), wa(), se(), Ke(), we(), Ua(), _a(), Ca(), Le(), setTimeout(Le, 1e3), $a(), Tn(), s.off("scroll.parallaxSections").off("resize.parallaxSections"), We(), Ae(), ei(), Un(), M.length > 0)
                for (a = 0; a < M.length; a++) M[a].portfolioAccentColor();
            if (qn(), Vn(), setTimeout(function() {
                    if (t(".nectar_fullscreen_zoom_recent_projects").length > 0 && D.length > 0)
                        for (var e = 0; e < D.length; e++) D[e].sliderCalcs()
                }, 300), s.unbind(".infscr"), Xn(), qe(), t(".nectar-video-wrap").each(function() {
            ...
            }, 100), ni(), void 0 !== e.Waypoint && (Waypoint.destroyAll(), Ka())
        })
    }
    ...
    function fi() {
        ...
        if (t('body[data-ajax-transitions="true"]').length > 0 && t('#ajax-loading-screen[data-disable-mobile="1"]').length > 0 && pt.winW < 1e3 && (a = !0), t('body[data-ajax-transitions="true"]').length > 0 && t('#ajax-loading-screen[data-method="standard"]').length > 0 && 0 == a) {
            ...
            opacity: "0",
            display: "none"
        }).addClass("loaded").addClass("hidden"), 0 != t(".nectar-box-roll").length || pt.usingFrontEndEditor || Ka()
    }

    function gi(n) {
        var i, l, u, p, g;
        pt.usingMobileBrowser && pt.scrollPosRAF(), sa(),
            function() {
                var n;
                if (zt(), 0 != t('body[data-header-format="left-header"]').length || pt.usingPhoneBrowser || (n = !(t('#header-outer[data-megamenu-rt="1"]').length > 0 && t('#header-outer[data-transparent-header="true"]').length > 0), t(".sf-menu:not(.buttons)").superfish({
                        delay: 500,
                        speed: "fast",
                        disableHI: n,
                        speedOut: "fast",
            ...
            function() {
                ...
                r.hasClass("material") && 0 == t("#header-outer .bg-color-stripe").length && d.append('<div class="bg-color-stripe" />'), r.on("click", "#search-btn a", function() {
                    ...
                    }, 300), t(this).toggleClass("open-search"), t(".slide-out-widget-area-toggle a:not(#toggle-nav).open:not(.animating)").trigger("click"), !1)
            ...
            }(), 0 == t('#header-outer[data-remove-fixed="1"]').length && pt.winW > 1e3 && 0 != t(e).scrollTop() && 1 == t('#header-outer.transparent[data-permanent-transparent="false"]').length && d.removeClass("transparent"), pt.winW < 1e3 ? (0 == t(".nectar-box-roll").length || "1" == I && 0 == t('#header-outer[data-remove-fixed="1"]').length) && (wn(), s.on("smartresize.nectarNavScrollEffects", wn)) : (yn(), s.on("smartresize.nectarNavScrollEffects", yn)), ni(), ga(), _e(), Ya(), i = t("#top #mobile-menu").length > 0 ? "#top #mobile-menu " : ".off-canvas-menu-container.mobile-only ", t(i + ".menu-item > ul > li > a").each(function() {
            ...
            }), Ia(), "separate-dropdown-parent-link" == (t("#slide-out-widget-area[data-dropdown-func]").length > 0 ? o.attr("data-dropdown-func") : "default") && t("#slide-out-widget-area .off-canvas-menu-container li.menu-item-has-children").append('<span class="ocm-dropdown-arrow"><i class="fa fa-angle-down"></i></span>'),
            function() {
            ...
            }), Ae(), se(), Xn(), Qn(), g = y - y / 1.8, r.on("click", ".section-down-arrow, .scroll-down-wrap > .minimal-arrow", function() {
                ...
                if (H && r.on("click", '#header-outer nav .sf-menu li:not(.slide-out-widget-area-toggle) a[href*="#"]', function() {
                    ...
                    setTimeout(Zn, 100), r.on("click", "#header-outer nav .sf-menu a, #header-outer .mobile-header .sf-menu a, #footer-outer .nectar-button, #footer-outer .widget_nav_menu a, #footer-widgets .textwidget a, #mobile-menu li a, .nectar-scrolling-tabs:not(.navigation_func_active_link_only) .scrolling-tab-nav a, .container-wrap a:not(.wpb_tabs_nav a):not(.navigation_func_active_link_only .scrolling-tab-nav a):not(.comment-wrap .navigation a):not(.woocommerce-checkout a):not(.um-woo-view-order):not(.magnific):not([data-fancybox]):not(.woocommerce-tabs .tabs a):not(.slider-prev):not(.slider-next):not(.testimonial-next-prev a):not(.page-numbers), .swiper-slide .button a, #slide-out-widget-area a, #slide-out-widget-area .inner div a", function(i) {
                        ...
                        if ((t(".page-template-template-no-header-footer").length > 0 || t(".page-template-template-no-header").length > 0 || 0 == t("#header-space").length) && (h = 0), 0 != ut.$usingFullScreenRows && t('#nectar_fullscreen_rows[data-anchors="on"]').length > 0 && l && "" != l && "#top" != l && t('body.material[data-slide-out-widget-area-style="slide-out-from-right"].material-ocm-open').length > 0 && (i.preventDefault(), t(this).hasClass("skip-hash") || (history.pushState ? history.pushState(null, null, l) : location.hash = l), setTimeout(function() {
                            ...
                            var p = 1,
                                f = t(this);
                            t(".nectar-box-roll").length > 0 && t(".container-wrap.bottomBoxOut").length > 0 && (ht.boxRoll(null, -1), p = 2050), t("img[data-nectar-img-src]").length > 0 && (ea(), p = 200), setTimeout(function() {
                                var e;
                                if (!0 === E) {
    ...
    function mi() {
        0 == t(e).scrollTop() && _n(), t("video").css("visibility", "visible"), t('body[data-animated-anchors="true"]').length > 0 && (0 == t(".nectar-box-roll").length && 0 == t("#nectar_fullscreen_rows").length && (void 0 !== ee.tab ? setTimeout(function() {
            Gn()
        }, 800) : Gn()), t('#nectar_fullscreen_rows[data-mobile-disable="on"]').length > 0 && 0 == t(".nectar-box-roll").length && pt.usingMobileBrowser && Gn()), Le(), pt.usingMobileBrowser || Be(), ka()
    }
