    ...
    if (t.console = t.console || {
        ...
        if (n.fn.fancybox) console.info("fancyBox already initialized");
            ...
            n.extend(g.prototype, {
                ...
                cleanUp: function(e) {
                    var o, i, s = this.current.opts.$orig;
                    this.current.$slide.trigger("onReset"), this.$refs.container.empty().remove(), this.trigger("afterClose", e), this.current.opts.backFocus && (s && s.length && s.is(":visible") || (s = this.$trigger), s && s.length && (t.scrollX, i = t.scrollY, s.trigger("focus"), n("html, body").scrollTop(i).scrollLeft(0))), this.current = null, (o = n.fancybox.getInstance()) ? o.activate() : (n("body").removeClass("fancybox-active compensate-for-scrollbar"), n("#fancybox-style-noscroll").remove())
                },
...
function(t) {
    ...
    t(document).on("objectNeedsType.fb", function(o, i, s) {
        ...
        a = t.extend(!0, {}, e, s.opts.media), t.each(a, function(e, o) {
            var i = f.match(/^.+vimeo.com\/(?:\/)?([\d]+)((\/|\?h=)([a-z0-9]+))?(.*)?/);
            if ("vimeo" === e && i && i[3] && i[4]) {
                var a = void 0 !== i[5] && i[5] ? i[5].replace("?", "&") : "",
                    g = t.param(o.params, !0);
                return f = "https://player.vimeo.com/video/" + i[1] + "?h=" + i[4] + "&" + g + a, c = f.match(o.matcher), p = o.type, u = e, d = {}, l = t.extend(!0, {}, o.params, d), r = "function" === t.type(o.thumb) ? o.thumb.call(this, c, l, s) : n(o.thumb, c), !1
            }
