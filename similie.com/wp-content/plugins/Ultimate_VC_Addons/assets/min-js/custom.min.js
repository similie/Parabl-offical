! function(c) {
    ...
    function r(t, e) {
        var i, s;
        s = (i = parseInt(e.outerHeight())) / 2, t.css("padding-top", s + "px"), t.parent().css("margin-top", s + 20 + "px"), e.css("top", -i + "px")
    }

    function o(t) {
        0 < t.find(".timeline-icon-block").length && c(".timeline-block").each(function(t, e) {
            var i = c(this).find(".timeline-header-block"),
                ...
                o = s.outerWidth(),
                a = -o / 2,
                a = (parseInt(i.find(".timeline-header").css("padding-left").replace(/[^\d.]/g, "")), c(this).hasClass("timeline-post-left") ? (s.css({
                    left: a,
                    right: "auto"
    ...
    function i() {
        jQuery(".ult-animation").each(function() {
            if (jQuery(this).attr("data-animate")) {
                ...
                const r = jQuery(this).attr("data-animate"),
                    ...
                    a = (jQuery(this).attr("data-opacity_start_effect"), "opacity:1;-webkit-animation-delay:" + o + "s;-webkit-animation-duration:" + t + ";-webkit-animation-iteration-count:" + s + "; -moz-animation-delay:" + o + "s;-moz-animation-duration:" + t + ";-moz-animation-iteration-count:" + s + "; animation-delay:" + o + "s;animation-duration:" + t + ";animation-iteration-count:" + s + ";");
                var i = "opacity:1;-webkit-transition-delay: " + o + "s; -moz-transition-delay: " + o + "s; transition-delay: " + o + "s;";
                if (n(jQuery(this))) {
                    let t = jQuery(this).attr("style");
                    "opacity:0;" == (t = (t = void 0 === t ? "test" : t).replace(/ /g, "")) && 0 !== t.indexOf(i) && jQuery(this).attr("style", i), jQuery.each(e, function(t, e) {
                        e = jQuery(e);
                        let i = e.attr("style"),
                            s = (void 0 === i && (i = "test"), "");
                        s = 0 == i.indexOf(a) ? i : a + i, e.attr("style", s), n(e) && e.addClass("animated").addClass(r)
                    })
                }
            }
        })
    ...
    function n(t) {
        ...
        e = void 0 === (e = jQuery(t).hasClass("ult-animate-viewport") ? jQuery(t).data("opacity_start_effect") : e) || "" == e ? 2 : 100 - e, jQuery(t).outerHeight();
        return jQuery(t).offset().top - i <= s - s * (e / 100)
    }

    function a() {
        jQuery(".ult-new-ib").each(function(t, e) {
            var i, s, r = jQuery(this);
            r.hasClass("ult-ib-resp") && (i = jQuery(document).width(), s = r.data("min-width"), i <= r.data("max-width") && s <= i ? r.find(".ult-new-ib-content").hide() : r.find(".ult-new-ib-content").show())
        })
    }
    c.fn.vc_translate_row = function() {
        ...
        c(this).each(function(t, e) {
            let i = c(e).attr("data-row-effect-mobile-disable");
            if (i = void 0 === i ? "false" : i.toString(), "false" == ("true" == (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? "true" : "false") && "true" == i ? "true" : "false")) {
                var s = 100 - c(e).data("fadeout-percentage"),
                    r = c(e).outerHeight(),
                    r = c(e).offset().top - a + r;
                let i = 1;
                var s = n - n * (s / 100),
                    o = (s - r) / s * 1;
                0 < o && (i = 1 - o), r <= s ? (i < 0 ? i = 0 : 1 < i && (i = 1), c(e).children().each(function(t, e) {
        ...
        function i() {
            jQuery(".ifb-jq-height").each(function() {
                ...
                var t = parseInt(jQuery(this).find(".ifb-front > div").outerHeight(!0)),
                    ...
                    t = e < t ? t : e;
                jQuery(this).find(".ifb-front").css("height", t + "px"), jQuery(this).find(".ifb-back").css("height", t + "px"), (jQuery(this).hasClass("vertical_door_flip") || jQuery(this).hasClass("horizontal_door_flip") || jQuery(this).hasClass("style_9")) && jQuery(this).find(".ifb-flip-box").css("height", t + "px")
            }), jQuery(".ifb-auto-height").each(function() {
                var t, e;
                (jQuery(this).hasClass("horizontal_door_flip") || jQuery(this).hasClass("vertical_door_flip")) && (e = parseInt(jQuery(this).find(".ifb-front > div").outerHeight()), e = (t = parseInt(jQuery(this).find(".ifb-back > div").outerHeight())) < e ? e : t, jQuery(this).find(".ifb-flip-box").css("height", e + "px"))
            })
        ...
        jQuery(window).on("resize", function() {
            ...
            var t = jQuery(this).data("timeline-cutom-width"),
                t = (t && jQuery(this).css("width", 2 * t + 40 + "px"), parseInt(jQuery(this).width()), parseInt(jQuery(this).find(".timeline-block").width()), c(".jstime .timeline-wrapper").each(function() {
                    jQuery(this).masonry({
                        itemSelector: ".timeline-block"
                    })
                }), setTimeout(function() {
                ...
                }, 1e3), jQuery(this).find(".timeline-line ").next().hasClass("timeline-separator-text") || jQuery(this).find(".timeline-line").prepend("<span></span>"), jQuery(this).data("time_sep_color")),
        ...
        var e = jQuery(".ult-no-mobile").length,
            e = (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && 1 <= e ? jQuery(".ult-animation").css("opacity", 1) : i(), a(), jQuery(".ubtn").on("mouseenter", function() {
                const t = jQuery(this),
                    e = (t.find(".ubtn-text").css("color", t.data("hover")), t.find(".ubtn-hover").css("background", t.data("hover-bg")).addClass("ubtn-hover-active"), "" != t.data("hover-bg") && t.data("hover-bg"));
                setTimeout(function() {
                ...
                var t = jQuery(this),
                    e = (t.find(".ubtn-text").removeAttr("style"), t.find(".ubtn-hover").removeClass("ubtn-hover-active"), t.css("background", t.data("bg")), t.data("border-color"));
                let i = t.attr("style");
                ...
                t(this).bsf_appear(function() {
                    var t = parseFloat(jQuery(this).find(".stats-number").data("counter-value")),
                        e = jQuery(this).find(".stats-number").data("counter-value") + " ",
                        i = parseInt(jQuery(this).find(".stats-number").data("speed")),
                    ...
                    let o = jQuery(this).find(".stats-number").data("decimal"),
                        a = e.split("."),
                        n = (a = a[1] ? a[1].length - 1 : 0, !0);
                    "none" == o && (o = "");
                    e = {
                        useEasing: !0,
                        useGrouping: n = "none" != r,
                        separator: r,
                        decimal: o
                    };
                    const u = new countUp(s, 0, t, a, i, e);
                    setTimeout(function() {
                        u.start()
                    }, 500)
                })
        ...
        e && (jQuery(".vertical_door_flip").each(function(t, e) {
            ...
            const i = jQuery(this);
            var s;
            (0 < jQuery(this).find(".aio-icon-img").length ? (s = jQuery(this).find(".aio-icon-img"), r(i, s), s.find(".img-icon")) : (s = jQuery(this).find(".aio-icon"), r(i, s), jQuery(window))).on("load", function() {
                r(i, s)
            })
        })
    })
    ...
    function i() {
        jQuery(".ultimate-map-wrapper").each(function(t, e) {
            ...
            var e = jQuery(e).find(".ultimate_google_map").attr("id"),
                s = jQuery("#" + e).attr("data-map_override");
            let r = "true",
                o = (jQuery("#" + e).css({
                    "margin-left": 0
                }), jQuery("#" + e).css({
            ...
            o;
            if ("full" == s && (o = jQuery("body"), r = "false"), "ex-full" == s && (o = jQuery("html"), r = "false"), !isNaN(s))
                for (t = 0; t < s && "HTML" != o.prop("tagName"); t++) o = o.parent();
            i = 0 == s || "0" == s ? o.width() : o.outerWidth();
            var a = o.offset().left - jQuery("#" + e).offset().left;
            jQuery("#" + e).css({
                width: i
            }), 0 == s && "0" == s || jQuery("#" + e).css({
                "margin-left": a
            }), "full" == s && jQuery("body").hasClass("rtl") && (i = jQuery("#" + e), a = jQuery(window).width() - (i.offset().left + i.outerWidth()), jQuery("#" + e).css({
                right: -a
            }))
        })
    }
