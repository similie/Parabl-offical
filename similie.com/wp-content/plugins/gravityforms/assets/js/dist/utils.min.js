! function() {
    ...
    function H(t, e) {
        return !1 !== e.clone && e.isMergeableObject(t) ? W((n = t, Array.isArray(n) ? [] : {}), t, e) : t;
        var n
    }
    ...
    function z(t, e, n) {
        ...
        return e.forEach((function(e, o) {
            void 0 === r[o] ? r[o] = n.cloneUnlessOtherwiseSpecified(e, n) : n.isMergeableObject(e) ? r[o] = W(t[o], e, n) : -1 === t.indexOf(e) && r.push(e)
        })), r
    }
    ...
    function U(t, e, n) {
        var r = {};
        return n.isMergeableObject(t) && J(t).forEach((function(e) {
            r[e] = H(t[e], n)
        })), J(e).forEach((function(o) {
            (function(t, e) {
                return R(t, e) && !(Object.hasOwnProperty.call(t, e) && Object.propertyIsEnumerable.call(t, e))
            })(t, o) || (R(t, o) && n.isMergeableObject(e[o]) ? r[o] = function(t, e) {
                if (!e.customMerge) return W;
                var n = e.customMerge(t);
                return "function" == typeof n ? n : W
            }(o, n)(t[o], e[o], n) : r[o] = H(e[o], n))
        })), r
    }
    ...
    function W(t, e) {
        ...
        }(n), n.isMergeableObject = n.isMergeableObject || F, n.cloneUnlessOtherwiseSpecified = H;
        var r = Array.isArray(e);
        return r === Array.isArray(t) ? r ? n.arrayMerge(t, e, n) : U(t, e, n) : H(e, n)
    }
    W.all = function(t, e) {
    ...
    var ct = function(t, e, n, r) {
            if ("length" !== n && "prototype" !== n && "arguments" !== n && "caller" !== n) {
                ...
                !ut(o, i) && r || Object.defineProperty(t, n, i)
            }
        },
        ut = function(t, e) {
        ...
        ft = Object.getOwnPropertyDescriptor(Function.prototype, "toString"),
        dt = Object.getOwnPropertyDescriptor(Function.prototype.toString, "name"),
        pt = function(t, e, n) {
            var r = "" === n ? "" : "with ".concat(n.trim(), "() "),
                o = st.bind(null, r, e.toString());
            Object.defineProperty(o, "name", dt), Object.defineProperty(t, "toString", at(at({}, ft), {}, {
                value: o
            }))
        };
    ...
    function St(t) {
        return function(t, e) {
            ...
            for (r = 0; r < d; r++)
                ...
                if ((i = t[r]).keys)
                    for (n = e[f], o = 0; o < i.keys.length; o++) {
                        if (null == n) throw new Error(St('[sprintf] Cannot access property "%s" of undefined value "%s"', i.keys[o], i.keys[o - 1]));
                        n = n[i.keys[o]]
                    } else n = i.param_no ? e[i.param_no] : e[f++];
                if (Ot.not_type.test(i.type) && Ot.not_primitive.test(i.type) && n instanceof Function && (n = n()), Ot.numeric_arg.test(i.type) && "number" != typeof n && isNaN(n)) throw new TypeError(St("[sprintf] expecting number but found %T", n));
                switch (Ot.number.test(i.type) && (l = n >= 0), i.type) {
                    case "b":
                ...
                Ot.json.test(i.type) ? p += n : (!Ot.number.test(i.type) || l && !i.sign ? s = "" : (s = l ? "+" : "-", n = n.toString().replace(Ot.sign, "")), c = i.pad_char ? "0" === i.pad_char ? "0" : i.pad_char.charAt(1) : " ", u = i.width - (s + n).length, a = i.width && u > 0 ? c.repeat(u) : "", p += i.align ? s + n + a : "0" === c ? s + a + n : a + s + n)
            }
            return p
        }(function(t) {
            if (Et[t]) return Et[t];
            var e, n = t,
                ...
                o = 0;
            for (; n;) {
                if (null !== (e = Ot.text.exec(n))) r.push(e[0]);
                else if (null !== (e = Ot.modulo.exec(n))) r.push("%");
                else {
                    if (null === (e = Ot.placeholder.exec(n))) throw new SyntaxError("[sprintf] unexpected placeholder");
                    if (e[2]) {
                        o |= 1;
                        var i = [],
                            a = e[2],
                            c = [];
                        if (null === (c = Ot.key.exec(a))) throw new SyntaxError("[sprintf] failed to parse named argument key");
                        for (i.push(c[1]);
                            "" !== (a = a.substring(c[0].length));)
                            if (null !== (c = Ot.key_access.exec(a))) i.push(c[1]);
                            else {
                                if (null === (c = Ot.index_access.exec(a))) throw new SyntaxError("[sprintf] failed to parse named argument key");
                                i.push(c[1])
                            }
                        e[2] = i
                    } else o |= 2;
    ...
    function jt(t, e) {
        return St.apply(null, [t].concat(e || []))
    }
    ...
    var Ct = function() {
                ...
                var i = o.onAnimateInit,
                    ...
                    m = function(t, e) {
                        ...
                        return (void 0 === m ? (null === (a = t.dataset) || void 0 === a ? void 0 : a.animationTypes) || "" : m).split(" ").forEach((function(t) {
                            "fadeIn" === t && (c.opacity = g || 0, u.opacity = h || 1), "fadeOut" === t && (c.opacity = g || 1, u.opacity = h || 0), "translateY" === t && (c.transform = "translateY(".concat(s, ")"), u.transform = "translateY(".concat(d, ")"))
                        })), [c, u]
                    }(r, o);
        ...
        Pt = /(android)/i.test(window.navigator.userAgent),
        Lt = !!window.chrome,
        _t = "undefined" != typeof InstallTrigger,
        It = document.documentMode || !1,
        Mt = !It && !!window.StyleMedia,
        Dt = !!window.navigator.userAgent.match(/(iPod|iPhone|iPad)/i),
        Ft = !!window.navigator.userAgent.match(/(iPod|iPhone)/i),
        Nt = !!window.opera || window.navigator.userAgent.indexOf(" OPR/") >= 0,
        Ht = Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor") > 0 || !Lt && !Nt && "undefined" !== window.webkitAudioContext,
        qt = window.navigator.platform;
    ...
    var Rt = 0,
        ...
        Wt = function() {
            ...
            Rt = e.scrollTop, n.overflowY = "scroll", n.position = "fixed", n.width = "100%", t && (n.marginTop = "-".concat(Rt, "px"))
        },
        Bt = function() {
            var t = Ut(),
                e = document.body.style;
            e.overflowY = "", e.position = "static", e.marginTop = "0px", e.width = "", t.scrollTop = Rt
        };
    ...
    function Yt(t) {
        ...
        t.addEventListener("mousedown", (function(n) {
            ...
            e.isDown = !1, t.classList.remove("drag-horizontal--active"), $t({
            ...
            if (e.isDown) {
                ...
                t.scrollLeft = e.scrollLeft - r, e.moveEventTriggered || ($t({
    ...
    function te() {
        var t = Zt(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", !1, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : document, arguments.length > 2 && void 0 !== arguments[2] && arguments[2]);
    ...
    var ve = function(t) {
            ...
            n.instances && t && Zt("[data-simplebar]", !0, t, !0).forEach((function(t) {
                var e;
        ...
        we = function(t) {
            me[t].up && (window.cancelAnimationFrame(me[t].up), me[t].up = null), me[t].down && (window.cancelAnimationFrame(me[t].down), me[t].down = null)
        },
        Oe = function(t, e) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 400,
                ...
                i = Qt(t),
                a = null;
            t.style.maxHeight = "0", be(e), we(e);
            var c = function c(u) {
                a || (a = u);
                var l = u - a,
                    s = ye(l / n) * (i - o) + o;
                t.style.maxHeight = "".concat(s, "px"), l < n ? me[e].down = window.requestAnimationFrame(c) : (me[e].down = null, t.style.maxHeight = "none", r && r())
            };
            setTimeout((function() {
                me[e].down = window.requestAnimationFrame(c)
            }), he)
        },
        Se = function(t, e) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 400,
                ...
                o = t.offsetHeight,
                i = null;
            t.style.maxHeight = "".concat(o, "px"), be(e), we(e);
            var a = function a(c) {
                i || (i = c);
                var u = c - i,
                    l = ye(u / n) * (0 - o) + o;
                t.style.maxHeight = "".concat(l, "px"), u < n ? me[e].up = window.requestAnimationFrame(a) : (me[e].up = null, t.style.maxHeight = "0", r && r())
            };
            setTimeout((function() {
                me[e].up = window.requestAnimationFrame(a)
            }), he)
        };
    ...
    function Ae() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
            ...
            n = {};
        return !t || "string" != typeof t && "number" != typeof t && !Array.isArray(t) && ("object" !== _(t) || Array.isArray(t)) || Array.isArray(t) && !t.length ? n : (n[e] = !0, "string" == typeof t || "number" == typeof t || Array.isArray(t) ? Ee(Ee({}, n), xe(t, "", e)) : ["", "md", "lg"].reduce((function(n, r) {
            return Object.prototype.hasOwnProperty.call(t, r) ? Ee(Ee({}, n), xe(t[r], r ? "".concat(r, "-") : "", e)) : n
        }), n))
    }
    var Te = function() {
    ...
    function Le(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        if ("function" != typeof t) throw new TypeError("Expected the first argument to be a function, got `".concat(_(t), "`"));
        var n, r, o, i = e.wait,
            a = void 0 === i ? 0 : i,
            c = e.maxWait,
        ...
        return gt(p, t), p.cancel = function() {
            n && (clearTimeout(n), n = void 0), r && (clearTimeout(r), r = void 0)
        }, p
    }
    var _e = 9;
    if ("undefined" != typeof Element && !Element.prototype.matches) {
        var Ie = Element.prototype;
        Ie.matches = Ie.matchesSelector || Ie.mozMatchesSelector || Ie.msMatchesSelector || Ie.oMatchesSelector || Ie.webkitMatchesSelector
    }

    function Me(t, e, n, r, o) {
        var i = De.apply(this, arguments);
    ...
    var Fe = function(t, e, n, r) {
        ...
        return "function" == typeof t.addEventListener ? Me.apply(null, arguments) : "function" == typeof n ? Me.bind(null, document).apply(null, arguments) : ("string" == typeof t && (t = document.querySelectorAll(t)), Array.prototype.map.call(t, (function(t) {
            return Me(t, e, n, r, o)
        })))
    };
    ...
    function He() {
        ...
        !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2] ? window.addEventListener("resize", Le(t, {
            wait: e
        })) : window.removeEventListener("resize", Le(t, {
            wait: e
        }))
    }
    ...
    var Ve;
    Ve = window.gform.utils, Object.entries(l).forEach((function(t) {
        var e = f(t, 2),
            n = e[0],
            r = e[1];
        Ve[n] = r
