...
function announceAJAXValidationErrors() {
    var e;
    jQuery(".gform_validation_errors").length && ((e = document.querySelector('[data-js="gform-focus-validation-error"]')) && (e.setAttribute("tabindex", "-1"), e.focus()), setTimeout(function() {
...
void 0 === jQuery.fn.prop && (jQuery.fn.prop = jQuery.fn.attr), jQuery(document).on("gform_post_render", announceAJAXValidationErrors), jQuery(document).on("gform_post_render", gformBindFormatPricingFields), gform.instances = {}, gform.console = {
    error: function(e) {
...
function gformToggleIcons(e, t) {
    ...
    e.find(".delete_list_item").css("visibility", 1 == r ? "hidden" : "visible"), 0 < t && t <= r ? (i.data("title", e.find(".add_list_item").attr("title")), i.addClass("gfield_icon_disabled").attr("title", ""), n || i.prop("disabled", !0)) : 0 < t && (i.removeClass("gfield_icon_disabled"), n || i.prop("disabled", !1), i.data("title")) && i.attr("title", i.data("title"))
}
...
var GFMergeTag = function() {
        GFMergeTag.getMergeTagValue = function(e, t, r) {
            ...
            if (!1 === a) {
                ...
                if (1 === (o = "checkbox" !== o.prop("type") && "radio" !== o.prop("type") ? o : o.filter(":checked")).length) {
                    ...
                    for (var f, d = [], c = 0; c < o.length; c++) "checkbox" === o.prop("type") && "" === r ? ((f = jQuery(o[c]).next("label").clone()).find("span").remove(), d[c] = GFMergeTag.formatValue(f.text(), r), f.remove()) : d[c] = GFMergeTag.formatValue(jQuery(o[c]).val(), r);
                    a = d.join(", ")
                }
            }
            return a
    ...
    GFCalc = (new GFMergeTag, function(formId, formulaFields) {
        this.formId = formId, this.formulaFields = formulaFields, this.exprPatt = /^[0-9 -/*\(\)]+$/i, this.isCalculating = {}, this.init = function(e, t) {
            ...
            var n, o, a, l, s, c, f = GFMergeTag.parseMergeTags(t);
            for (i in f) f.hasOwnProperty(i) && (n = f[i][1], (o = parseInt(n, 10)) == r.field_id && o == n || (a = "value", f[i][3] ? a = f[i][3] : (c = jQuery(".gfield_price input[name=input_" + o + "]").is("input[type=radio]"), s = 0 < jQuery(".gfield_price select[name=input_" + o + "]").length, l = jQuery('.gfield_price input[name="input_' + n + '"]').is("input[type=checkbox]"), (s || c || l) && (a = "price")), c = (s = !window.gf_check_field_rule || "show" == gf_check_field_rule(e, o, !0, "")) ? GFMergeTag.getMergeTagValue(e, n, a) : 0, c = gform.applyFilters("gform_merge_tag_value_pre_calculation", c, f[i], s, r, e), c = this.cleanNumber(c, e, o, r), t = t.replace(f[i][0], c)));
            return t
...
function gformInitSpinner(t, r, i = !0) {
    gform.applyFilters("gform_spinner_url", r, t) != r && (i = !0), jQuery("#gform_" + t).on("submit", function() {
        var e;
        i ? gformAddSpinner(t, r) : (e = gform.applyFilters("gform_spinner_target_elem", jQuery("#gform_submit_button_" + t + ", #gform_wrapper_" + t + " .gform_next_button, #gform_send_resume_link_button_" + t), t), gformInitializeSpinner(t, e))
    })
}
...
gform.recaptcha = {
    ...
    function i(o) {
        ...
        f = t.settings.multipart_params.form_id, (g.uploaders[e.container] = t).bind("Init", function(e, t) {
            var r, i, n;
    ...
    m(document).on("gform_post_render", function(e, t) {
        ...
        0 < r.length && r.on("submit", function() {
            var r = !1;
