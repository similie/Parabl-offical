! function o(n, r, s) {
    ...
    1: [function(t, e, i) {
        ...
        function a(a, d, h) {
            for (var u = +new Date, t = window.getComputedStyle(a), g = {}, f = {}, e = 0, i = Object.keys(d); e < i.length; e++) {
                var o = i[e];
                d[o] = parseFloat(d[o]);
                var n = d[o],
                    r = parseFloat(t[o]);
                r !== n ? (f[o] = (n - r) / s, g[o] = r) : delete d[o]
            }(function t() {
                for (var e = +new Date - u, i = !0, o = 0, n = Object.keys(d); o < n.length; o++) {
                    var r = n[o],
                        s = f[r],
                        l = d[r],
                        c = s * e,
                        c = g[r] + c;
                    0 < s && l <= c || s < 0 && c <= l ? c = l : i = !1, g[r] = c, a.style[r] = "opacity" !== r ? c + "px" : c
                }
                u = +new Date, i ? h && h() : window.requestAnimationFrame(t)
            })()
        }
        e.exports = {
            toggle: function(t, e, i) {
                ...
                var n, r, s = "none" !== t.style.display || 0 < t.offsetLeft,
                    l = t.cloneNode(!0);
                t.setAttribute("data-animated", "true"), s || (t.style.display = ""), "slide" === e ? (r = function(t, e) {
                    for (var i = {}, o = 0; o < t.length; o++) i[t[o]] = e;
                    return i
                }(["height", "borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"], 0), n = {}, s || (n = function(t, e) {
                    for (var i = {}, o = 0; o < t.length; o++) i[t[o]] = e[t[o]];
                    return i
                }(["height", "borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"], window.getComputedStyle(t)), isFinite(n.height) || (e = t.getBoundingClientRect(), n.height = e.height), c(t, r)), t.style.overflowY = "hidden") : (r = {
                    opacity: 0
                }, n = {
                    opacity: 1
                }, s || c(t, r)), a(t, s ? r : n, o)
    ...
    2: [function(t, e, i) {
        ...
        function r(t, e, i) {
            this.id = t, this.fireEvent = i, this.config = function(t, e) {
                for (var i = {}, o = 0, n = Object.keys(t); o < n.length; o++) {
                    var r = n[o];
                    i[r] = t[r]
                }
                for (var s = 0, l = Object.keys(e); s < l.length; s++) {
                    var c = l[s];
                    i[c] = e[c]
                }
                return i
            }(o, e), this.overlay = document.createElement("div"), this.overlay.setAttribute("aria-modal", !0), this.overlay.style.display = "none", this.overlay.id = "boxzilla-overlay-" + this.id, this.overlay.classList.add("boxzilla-overlay"), document.body.appendChild(this.overlay), this.visible = !1, this.dismissed = !1, this.triggered = !1, this.triggerHeight = this.calculateTriggerHeight(), this.cookieSet = this.isCookieSet(), this.element = null, this.contentElement = null, this.closeIcon = null, this.dom(), this.events()
        }
        r.prototype.events = function() {
            ...
            this.closeIcon && this.closeIcon.addEventListener("click", function(t) {
                ...
                "A" !== t.target.tagName && "AREA" !== t.target.tagName || o.fireEvent("box.interactions.link", [o, t.target])
            }, !1), this.element.addEventListener("submit", function(t) {
                o.setCookie(), o.fireEvent("box.interactions.form", [o, t.target])
            }, !1), this.overlay.addEventListener("click", function(t) {
                var e = t.offsetX,
                    i = t.offsetY,
                    t = o.element.getBoundingClientRect();
                (e < t.left - 40 || e > t.right + 40 || i < t.top - 40 || i > t.bottom + 40) && o.dismiss()
            })
            ...
            o.id = "boxzilla-" + this.id, o.className = "boxzilla boxzilla-" + this.id + " boxzilla-" + this.config.position, o.style.display = "none", t.appendChild(o), "string" == typeof this.config.content ? (e = document.createElement("div")).innerHTML = this.config.content : (e = this.config.content).style.display = "", e.className = "boxzilla-content", o.appendChild(e), this.config.closable && this.config.icon && ((i = document.createElement("span")).className = "boxzilla-close-icon", i.innerHTML = this.config.icon, i.setAttribute("aria-label", "close"), o.appendChild(i), this.closeIcon = i), document.body.appendChild(t), this.contentElement = e, this.element = o
            ...
            e < i && (this.element.style.maxHeight = e + "px", this.element.style.overflowY = "scroll"), "center" === this.config.position && (i = 0 <= (i = (e - i) / 2) ? i : 0, this.element.style.marginTop = i + "px"), this.element.style.display = t
    ...
    3: [function(t, e, i) {
        ...
        function m(t) {
            for (var e = t.target, i = 0; i <= 3 && (e && "A" !== e.tagName && "AREA" !== e.tagName); i++) e = e.parentElement;
            !e || "A" !== e.tagName && "AREA" !== e.tagName || !e.href || (t = e.href.match(/[#&]boxzilla-(.+)/i)) && 1 < t.length && y(t[1])
        }
        ...
        function v(t, e) {
            t ? b(t).dismiss(e) : h.forEach(function(t) {
                return t.dismiss(e)
            })
        }

        function y(t, e) {
            t ? b(t).toggle(e) : h.forEach(function(t) {
                return t.toggle(e)
            })
        }
        t = {
            ...
            init: function() {
                var t;
                d || ((t = document.createElement("style")).innerHTML = r, document.head.appendChild(t), s(h), c(h), l(h), a(h), document.body.addEventListener("click", m, !0), window.addEventListener("resize", n(f)), window.addEventListener("load", f), document.addEventListener("keyup", g), p("ready"), d = !0)
            },
            create: function(t, e) {
                return void 0 !== e.minimumScreenWidth && (e.screenWidthCondition = {
                    condition: "larger",
                    value: e.minimumScreenWidth
                }), t = String(t), e = new o(t, e, p), h.push(e), e
            },
            trigger: p,
            show: function(t, e) {
                t ? b(t).show(e) : h.forEach(function(t) {
                    return t.show(e)
                })
            },
            hide: function(t, e) {
                t ? b(t).hide(e) : h.forEach(function(t) {
                    return t.hide(e)
                })
            },
            dismiss: v,
        ...
        window.Boxzilla = t, void 0 !== e && e.exports && (e.exports = t)
    }, {
        "./box.js": 2,
        "./styles.js": 4,
    ...
    9: [function(t, e, i) {
        ...
        e.exports = function(t) {
            ...
            o(), document.addEventListener("visibilitychange", function() {
                ...
                t.forEach(function(t) {
                    ("time_on_site" === t.config.trigger.method && e.time > t.config.trigger.value && t.mayAutoShow() || "time_on_page" === t.config.trigger.method && i.time > t.config.trigger.value && t.mayAutoShow()) && t.trigger()
                })
            }, 1e3)
        }
    }, {
    ...
    11: [function(t, e, i) {
        ...
        var r, s, l;
        r = t("./boxzilla/boxzilla.js"), s = window.boxzilla_options, (l = document.body && document.body.className && -1 < document.body.className.indexOf("logged-in")) && s.testMode && console.log("Boxzilla: Test mode is enabled. Please disable test mode if you're done testing."), r.init(), window.addEventListener("load", function() {
            if (!s.inited) {
                for (var t in s.boxes) {
                    var e = s.boxes[t];
                    e.testMode = l && s.testMode;
                    var i = document.getElementById("boxzilla-box-" + e.id + "-content");
                    if (i) {
                        e.content = i;
                        var o = r.create(e.id, e);
                        o.element.className = o.element.className + " boxzilla-" + e.post.slug, i = o.element, (e = e.css).background_color && (i.style.background = e.background_color), e.color && (i.style.color = e.color), e.border_color && (i.style.borderColor = e.border_color), e.border_width && (i.style.borderWidth = parseInt(e.border_width) + "px"), e.border_style && (i.style.borderStyle = e.border_style), e.width && (i.style.maxWidth = parseInt(e.width) + "px");
                        try {
                        ...
                        o.fits() && function(t) {
                            ...
                            if (!e || "object" !== n(e) || e.length < 2) return !1;
                            e = e[1]; {
                                if (e === t.element.id) return !0;
                                if (t.element.querySelector("#" + e)) return !0
                            }
                            return !1
                        }(o) && o.show()
                    }
                }
                s.inited = !0, r.trigger("done"),
                    function() {
                        if (("object" !== n(window.mc4wp_forms_config) || !window.mc4wp_forms_config.submitted_form) && "object" !== n(window.mc4wp_submitted_form)) return;
